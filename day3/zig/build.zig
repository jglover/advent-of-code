...
pub fn build(b: *std.Build) void {
    ...
    const part2_run_step = b.step("part2", "Run part 2");
    const part2_run_cmd = b.addRunArtifact(part2_exe);
    part2_run_step.dependOn(&part2_run_cmd.step);
    part2_run_cmd.step.dependOn(b.getInstallStep());
